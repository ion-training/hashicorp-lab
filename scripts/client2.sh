...
cp -ap /vagrant/conf/client2/nomad.hcl /etc/nomad.d/
chown -R nomad: /etc/nomad.d /opt/nomad/

# nomad set bash env
cp -ap /vagrant/conf/client2/nomad-bash-env.sh /etc/profile.d/
...
# copy consul config
cp -ap /vagrant/conf/client2/consul.hcl /etc/consul.d/
chown -R consul: /etc/consul.d /opt/consul/

# consul set bash env
cp -ap /vagrant/conf/client2/consul-bash-env.sh /etc/profile.d/
